...
def initialize_parameters(n_x, n_h, n_y):
    ...
    W1 = np.random.randn(n_h, n_x) # Weigths on first hidden layer
    b1 = np.zeros((n_h, 1))        # Bias terms on first layer
